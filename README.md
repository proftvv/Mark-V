...
![Version](https://img.shields.io/badge/version-0.0.9--R2-blue)
...
- 🖥️ **Sistem tepsisi desteği** (minimize edildiğinde tray'de çalışır)
- 🌓 **Açık/Koyu tema** (tek tuşla tema değiştirme)
